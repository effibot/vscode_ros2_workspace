...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('kart_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'rviz_conf.rviz'])
